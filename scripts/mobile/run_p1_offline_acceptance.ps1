# Orchestrate p1_offline_test.dart with adb airplane-mode toggles.
...
$logFile = Join-Path $env:TEMP "p1_offline_logcat.txt"
...
$testJob = Start-Job -ScriptBlock {
    ...
    Set-Location $app
    flutter test integration_test/p1_offline_test.dart -d $Device `
