...
/// 模拟器冒烟验收：登录后逐域打读路径（P1 派工/工作台 + P2 协作 + P3 事项/战情）。
///
/// ```
/// flutter test integration_test/p2_p3_smoke_test.dart -d emulator-5554 \
...
const String kDeviceId = 'p2-p3-smoke-device';
...
void main() {
  ...
  testWidgets('P2/P3 smoke: login + domain reads all 200-class', (tester) async {
    await ensureRust();
