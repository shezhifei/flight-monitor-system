...
impl DefaultMQAdminExtImpl {
    ...
    pub async fn pull_message_from_queue(
        ...
        self.pull_message_from_queue_for_group(
            broker_addr,
    ...
    pub async fn pull_message_from_queue_for_group(
        &self,
        broker_addr: &str,
        consumer_group: &str,
        mq: &MessageQueue,
        ...
        let request_header = PullMessageRequestHeader {
            consumer_group: CheetahString::from(consumer_group),
...
impl MQAdminExt for DefaultMQAdminExtImpl {
    ...
    async fn update_consume_offset(
        ...
        let request_header = UpdateConsumerOffsetRequestHeader {
            ...
            topic: mq.topic().clone(),
            queue_id: mq.queue_id(),
            commit_offset: offset as i64,
            topic_request_header: None,
        };
        self.client_instance
            .as_ref()
            .unwrap()
            .update_consumer_offset(&broker_addr, request_header, self.timeout_millis.as_millis() as u64)
            .await
    }
