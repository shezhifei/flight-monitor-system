...
pub fn configure_app(cfg: &mut web::ServiceConfig, di: &DiContainer) {
    ...
    cfg.app_data(web::Data::new(di.jwt_secret.clone()))
        ...
        .app_data(web::Data::new(di.metadata_catalog_svc.clone()))
        .app_data(web::Data::new(di.field_overlay_svc.clone()))
        .app_data(web::Data::new(di.flight_monitor_row_svc.clone()))
