...
pub async fn build_di_container(
    ...
    Ok(DiContainer {
        ...
        terminal_resource_svc: dispatch.terminal_resource_svc.clone(),
        metadata_catalog_svc: dispatch.metadata_catalog_svc.clone(),
        field_overlay_svc: dispatch.field_overlay_svc.clone(),
        flight_monitor_row_svc: dispatch.flight_monitor_row_svc.clone(),
