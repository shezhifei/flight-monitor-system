...
class TestSubagentConcurrencyControl:
    ...
    async def test_semaphore_enforces_max_concurrency(self):
        ...
        dispatcher = SubagentDispatcher(runtime_service_factory=fake_runtime_factory, max_concurrency=2)
    ...
    async def test_per_entity_semaphore_isolation(self):
        ...
        dispatcher = SubagentDispatcher(runtime_service_factory=fake_runtime_factory, max_concurrency=1)
...
async def test_global_concurrent_subagent_runs():
    ...
    dispatcher = SubagentDispatcher(runtime_service_factory=fake_runtime_factory, max_concurrency=5)
