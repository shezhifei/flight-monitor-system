"""Tests for AI Config V2 management endpoints.
...
class TestCapabilityResolverMcpMerging:
    ...
    def _make_resolver_with_mcp_repo(self, mcp_repo, entity_config=None):
        ...
        mock_normalizer.normalize_config_to_v2 = lambda x: x
        ...
        class FakeConfigStore:
            async def get(self, entity_id):
                return entity_config or {
                    ...
                    "provider": {"type": "openai_compatible", "api_format": "chat_completions"},
                    "tooling": {
                        "enabled": True,
...
# ---------------------------------------------------------------------------
# Tests: config_revision compat
# ---------------------------------------------------------------------------


class TestConfigRevisionCompat:
...
class TestMultimodalInference:
    ...
    def test_text_only_model_rejects_image(self):
        # Patch normalize_config_to_v2 at the module level via sys.modules
        import sys
