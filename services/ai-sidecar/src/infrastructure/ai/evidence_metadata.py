...
class FreshnessValidator:
    ...
    MAX_AGE_THRESHOLDS: ClassVar[dict[str, int]] = {
    ...
    @classmethod
    def is_data_stale(
        cls, tool_name: str, as_of: datetime | str | None, now: datetime | str | None = None
    ) -> tuple[bool, float]:
    ...
    def validate_evidence(
        cls, evidence: list[dict[str, Any]], tool_name: str, now: datetime | str | None = None
