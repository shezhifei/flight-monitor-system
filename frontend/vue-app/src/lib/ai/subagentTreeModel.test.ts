// 搬运自 frontend/ai-react/src/components/chat/subagentTreeModel.test.ts。
// 适配点：源文件末尾的 'SubagentTree component' describe 渲染的是
// SubagentTree.tsx（React 组件，不在搬运范围），已剔除；其余用例不变。
